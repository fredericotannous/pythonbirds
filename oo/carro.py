...
2: um metodo acelerar que deverá incrementar a velocidade de uma unidade
3: método frear que deverá decrementar a velocidade em 2 unidades

A Direção tera a responsabilidade de controlar a direção. Ela
